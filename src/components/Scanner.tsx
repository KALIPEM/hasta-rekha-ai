...
function IndividualScanner({ onCancel, onScanComplete, initialRoast, status, onSample, onPricing, onBusy }: Props & {onBusy:(v:boolean)=>void}) {
  ...
  return <section className="scanner-page section-width">
    ...
    </div><aside className="photo-tips"><PalmIllustration small/><h3>A little light goes a long way.</h3><ul><li><Sun size={18}/> Use soft, natural light.</li><li><Hand size={18}/> Open your hand and relax your fingers.</li><li><ImagePlus size={18}/> Include your palm, fingers, and wrist.</li><li><Check size={18}/> Keep the lines sharp and in focus.</li></ul></aside></div>}
